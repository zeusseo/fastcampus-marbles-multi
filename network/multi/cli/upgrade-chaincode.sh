...
CORE_PEER_ADDRESS=peer0.org1.example.com:7051 peer chaincode install -n marbles -v $1 -p $CHAINCODE_DIR/$1_cc
...
-C imchannel -n marbles -v $2  -c '{"Args":["init","a","200","b","200"]}' -P "OR   ('Org1MSP.peer','Org2MSP.peer')"
