...
gulp.task('marbles_multi', ['env_multi', 'watch-sass', 'watch-server', 'server']);	//run with command `gulp marbles_multi` for a multi network
...
// Local Fabric via Docker Compose
gulp.task('env_multi', function () {
    env['creds_filename'] = 'marbles_multi.json';
});
